...
public class Cmn131Form extends AbstractGsForm {
    ...
    /** グループ */
    private String cmn131groupSid__ = "-1";
    /** 追加用メンバー(選択中) */
    ...
    /** 追加参照権限 選択グループ */
    private String cmn131refGroupSid__ = "-1";
    /** 追加参照権限 選択グループのメンバー */
    ...
    /** メンバー 選択UI*/
    private UserGroupSelector cmn131userSidUI__ =
            UserGroupSelector.builder()
                ...
                //グループ選択保管パラメータ名
                .chainGroupSelectionParamName("cmn131groupSid")
                .build();
    /** 共有 選択UI*/
    private UserGroupSelector cmn131refUserSidUI__ =
            UserGroupSelector.builder()
                //ユーザ選択 日本語名（入力チェック時に使用）
                .chainLabel(new GsMessageReq("cmn.squad", null))
                //ユーザ選択タイプ
                ...
                //グループ選択保管パラメータ名
                .chainGroupSelectionParamName("cmn131refGroupSid")
                .build();
...
//        GSValidateCommon.validateMember(errors, cmn131userSid__);
     ...
     * @see jp.groupsession.v2.cmn.cmn131.Cmn131Form#cmn131userSidUI__
     */
     ...
     * @see jp.groupsession.v2.cmn.cmn131.Cmn131Form#cmn131refUserSidUI__
     */
